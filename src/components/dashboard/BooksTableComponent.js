...
const TableContent = ({ data, dispatch, saveThought , history}) => {
    return <tr>
        ...
        <td align="right">
            <span className="icon cursor-pointer" onClick={() => history.push(`/new_addition/${data.id}/edit/5`)}>
    ...
    return (
        <div className="content__inner">
            ...
            <ContentBoxComponent table={{
                ...
                list: props.bookTableProps,
                class: "table custom-table four-col-table"
            }}
                loading={props.loadingData}
                checkListLengthProps={props.bookTableLengthProps}
                title="books" />
        </div>
